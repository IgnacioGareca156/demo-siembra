...
import NuevaCartilla from './NuevaCartilla';
                                            ...
                                            {(() => {
                                                ...
                                                if (column.id === 'acciones') {
                                                    if (profesor?.profesor_admin) {
                                                        ...
                                                        return (
                                                            <>
                                                                <EditarCartilla cartilla_id={row.id} aulas={state.aulas} materias={state.materias} />
                                                                <EliminarCartilla cartilla_id={row.id} cartilla_file={row.cartilla_file} />
