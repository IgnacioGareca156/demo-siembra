...
const TablaNotificaciones = () => {
    ...
    const columns = [
        { id: 'noti_id', label: 'Id', minWidth: 170 },
                                            ...
                                            {(() => {
                                                ...
                                                if (column.id === 'acciones') {
                                                    if (profesor?.profesor_admin) {
                                                        ...
                                                        return (
                                                            <>
                                                                <EditarNotificacion noti_id={row.noti_id} aulas={state?.aulas} />
                                                                <EliminarNotificacion noti_id={row.noti_id} noti_file={row.noti_file} />
                                                        ...
                                                        return (
                                                            <>
                                                                <EditarNotificacion id={row.noti_id} aulas={state.aulas} />
                                                                <IconButton component={'a'} color='' aria-label='Ver Cartilla' size='large' target="_blank" href={`https://xer.pascalito.com.ar/assets/${row.noti_file}`}>
                                                                    <RemoveRedEyeSharpIcon />
                                                                </IconButton>
                                                            </>
