...
import EliminarVideo from './EliminarVideo';
...
const TablaVideos = () => {
    ...
    const columns = [
        { id: 'video_descripcion', label: 'Descripción', minWidth: 170 },
        { id: 'video_materia', label: 'Materia', minWidth: 100 },
        {
            id: 'video_aula',
            label: 'Aula',
            minWidth: 170,
        ...
        setTimeout(() => {
            ...
            setRows(
                state.videos?.map((video) => {
                    const aula = state?.aulas.find((aula) => aula.aula_id === video.video_aula);
                    const materia = state?.materias.find((materia) => materia.materia_id === video.video_materia);

                    // Obtener día, mes y año
                    const fecha = new Date(video.date_created)
                    ...
                    return {
                        ...
                        video_aula: aula?.aula_nombre,
                        video_materia: materia?.materia_nombre,
                                            ...
                                            {(() => {
                                                ...
                                                if (column.id === 'acciones') {
                                                    if (profesor?.profesor_admin) {
                                                        ...
                                                        return (
                                                            <>
                                                                <EditarVideo video_id={row.id} aulas={state.aulas} materias={state.materias} />
                                                                <EliminarVideo video_id={row.id} />
                                                                <VerVideo video={row} />
                                                            </>
                                                        );
                                                    } else {
                                                        ...
                                                        return (
                                                            <>
                                                                <EditarVideo video_id={row.id} aulas={state.aulas} materias={state.materias} />
                                                                <VerVideo video_link={row.video_link} />
                                                            </>
