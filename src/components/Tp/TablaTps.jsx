...
const TablaTps = () => {
    ...
    const columns = [
        { id: 'tp_id', label: 'Id', minWidth: 170 },
                                            ...
                                            {(() => {
                                                ...
                                                if (column.id === 'acciones') {
                                                    if (profesor?.profesor_admin) {
                                                        ...
                                                        return (
                                                            <>
                                                                <EditarTp tp_id={row.tp_id} aulas={state.aulas} materias={state.materias} />
                                                                <EliminarTp tp_id={row.tp_id} tp_file={row.tp_file} />
